...
<style>
    ...
    .peer:checked + span {
        ...
        transform: scale(1.1); /* Slight scaling for selected */
    }
</style>
...
<div class="max-w-3xl mx-auto p-6 bg-white shadow-md rounded">
    ...
    <form action="{{ route('quiz.submit') }}" method="POST">
        ...
        <div class="mb-8">
            ...
            <div class="flex justify-center items-center space-x-6">
                ...
                <label class="flex flex-col items-center">
                    ...
                    ">
                        <span class="sr-only">{{ $i }}</span> <!-- Accessible description -->
                    </span>
                </label>
                @endfor
        ...
        <div class="flex justify-center mb-6">
            <button 
                type="submit" 
                class="py-2 px-6 bg-[#766FFF] text-white font-semibold rounded-lg hover:bg-[#6858f2] transition duration-200">
                Submit Quiz
            </button>
        </div>
    </form>
    ...
    <div class="mt-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded">
        <h2 class="text-lg font-bold">Your Personality Type: <span class="text-[#766FFF]">{{ $result }}</span></h2>
    </div>
    @endif
</div>
@endsection
